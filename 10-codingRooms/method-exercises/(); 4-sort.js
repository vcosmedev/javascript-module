...
// Ordenar los autos del objeto por color de forma alfabetica a-z.

cars.sort((a, b) => a.color.localeCompare(b.color));
console.log(cars);

/* function orderCars(cars) {
    let compare = function() {
        autos.sort((a, b) => a.color.localeCompare(b.color));
console.log(autos);
    };
    cars.sort(compare);
    return cars;
...
let orderedCars = orderCars(cars);
